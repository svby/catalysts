...
private val buildings = LinkedList<Building5>()
private val seen = HashSet<Point>()

private data class Building5(val tiles: LinkedList<Vector3>) {
...
private fun recur(row: Int, column: Int) {
    ...
    buildings.push(Building5(LinkedList(listOf(p.toVector3(height)))))
